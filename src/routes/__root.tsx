...
const siteUrl = import.meta.env.VITE_SITE_URL || "https://abhaykumar.dev";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Abhay Kumar — AI/ML Engineer and Full Stack Developer building modern AI-powered applications and polished web experiences." },
      { name: "author", content: "Abhay Kumar" },
